...
public class TextEditor extends JFrame {
    ...
    private void initializeIcons() {
        ImageIcon icon = new ImageIcon("D:\\Text Editor\\Text Editor\\task\\src\\editor\\load.png");
        buttonLoad.setIcon(icon);

        icon = new ImageIcon("D:\\Text Editor\\Text Editor\\task\\src\\editor\\save.png");
        buttonSave.setIcon(icon);

        icon = new ImageIcon("D:\\Text Editor\\Text Editor\\task\\src\\editor\\search.png");
        buttonSearch.setIcon(icon);

        icon = new ImageIcon("D:\\Text Editor\\Text Editor\\task\\src\\editor\\prev.png");
        buttonPrev.setIcon(icon);

        icon = new ImageIcon("D:\\Text Editor\\Text Editor\\task\\src\\editor\\next.png");
